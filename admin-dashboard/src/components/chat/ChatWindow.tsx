...
export default function ChatWindow({ onToggleSidebar }: { onToggleSidebar?: () => void }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 h-full">
      ...
      <div className="flex items-center gap-3 px-4 h-14 border-b shrink-0" style={{ background: "var(--chat-header-bg)", borderColor: "var(--border)" }}>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-0.5 scrollbar-hide" style={{ background: "var(--chat-bg)" }}>
        {messages.length === 0 ? (
