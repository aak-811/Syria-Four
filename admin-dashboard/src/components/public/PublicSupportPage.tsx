        ...
        {sent ? (
          ...
          <form onSubmit={handleSend} className="space-y-4">
            ...
            <textarea placeholder="رسالتك..." rows={5} required
              className="w-full bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] rounded-[14px] px-4 py-3 text-sm text-white placeholder-[#6B7280] outline-none focus:border-[#E50914] transition-all duration-300 resize-none"
