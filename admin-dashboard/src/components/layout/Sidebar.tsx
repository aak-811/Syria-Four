...
import {
  ...
  ShoppingCart, HeadphonesIcon, Hand, Bot, MapPin, Shield,
} from "lucide-react";
  ...
  return (
    <aside className="fixed top-0 right-0 h-screen w-[260px] z-40 hidden lg:flex flex-col bg-[#050816] border-l border-[rgba(255,255,255,0.06)]">
      ...
      <div className="p-3 border-t border-[rgba(255,255,255,0.06)]">
        <Link href="/admin">
          <div className="flex items-center gap-3 px-4 py-3 rounded-[14px] text-sm font-medium text-[#6B7280] hover:text-white hover:bg-[rgba(255,255,255,0.05)] transition-all duration-300">
            <span className="text-[#8B5CF6]"><Shield size={18} /></span>
