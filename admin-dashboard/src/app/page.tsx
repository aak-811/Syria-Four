                      ...
                      <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-4">
                        ...
                        <div className="flex flex-wrap items-center gap-3 md:gap-4 text-xs text-[#6B7280]">
                          {t.type !== "previous" && t.startDate && (
                            <div className="flex items-center gap-1.5 glass rounded-[10px] px-3 py-1.5">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {gallery.slice(0, 4).map((img, i) => (
                  <div key={i} className="fade-in rounded-[14px] overflow-hidden aspect-square group cursor-pointer relative"
                    ...
                    <img src={img.src} alt={img.label || ""}
                      ...
                      onError={(e) => {
                        ...
                        t.parentElement!.classList.add("bg-[rgba(255,255,255,0.06)]", "flex", "items-center", "justify-center");
                        t.parentElement!.innerHTML = `<span class="text-[#6B7280] text-sm">${img.label || "صورة"}</span>`;
                      }}
                    />
